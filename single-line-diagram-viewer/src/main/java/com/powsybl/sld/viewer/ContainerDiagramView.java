...
public abstract class ContainerDiagramView extends BorderPane {
    ...
    private static void installWireHandlers(Node node, GraphMetadata metadata, GraphMetadata.WireMetadata wireMetadata, Map<String, NodeHandler> nodeHandlers, Map<String, WireHandler> wireHandlers) {
        ...
        Polyline polyline = (Polyline) ((Group) node).getChildren().get(0);
        WireHandler wireHandler = new WireHandler(polyline, nodeHandler1, nodeHandler2, wireMetadata.isStraight(),
